...
function Footer() {
  ...
  return (
    ...
    transition={{ duration: 0.7 }} className='w-full flex  gap-5 h-[60vw] bg-zinc-900 p-20 font-body '>
        <motion.div  initial={{ opacity: 0, y: 50 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 1 }} className='w-1/2 flex h-full flex-col justify-between'> 
        <div className='HEADING'>
        <h1 className='uppercase text-[9vw] font-bold leading-none -mb-5 '>EYE-</h1>
        <h1 className='uppercase text-[9vw] font-bold leading-none -mb-5 '>OPENING</h1>
        </div>
      ...
      transition={{ duration: 1 }} className='w-1/2'>
        <h1 className='uppercase text-[9vw] font-bold leading-none -mb-5 '>presentations
          
        </h1>
        <motion.div  initial={{ opacity: 0, y: 50 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 1 }} className='LINKS underline gap-1 text-[1.2vw] font-font3 w-full pt-[7vw] pr-[40vw] flex flex-col text-white'>
        ...
        <motion.div  initial={{ opacity: 0, y: 50 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 1 }} className='LINKS underline gap-10 text-[1.2vw] font-font3 w-full pt-[10vw] pl-[0vw] flex flex-col text-white'>
            <button className='w-[20vw] pr-[10vw]'>202-1965 W 4th Ave
            Vancouver, Canada</button>
            <button className='w-[20vw] pr-[10vw]'>30 Chukarina St
            Lviv, Ukraine</button>
            
            <motion.div  initial={{ opacity: 0, y: 50 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 1 }} className='items-start LINKS overflow-hidden underline gap-1 text-[1.2vw] font-font3  absolute flex flex-col text-white pl-[30vw] '>
            <button>Home</button>
